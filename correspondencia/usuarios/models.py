...
class Ajustes(models.Model):
    titulo = models.CharField(max_length=100, validators=[valor_minimo_titulo,solo_Alphabeto], verbose_name="Título", default="Sistema de Control y Seguimiento de Correspondencias")
